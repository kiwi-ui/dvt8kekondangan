  ...
  return (
    <section className="opening h-100">
      ...
      <div className={`d-flex flex-column justify-content-center align-items-center h-100 textPrime`}>
        <p className="fs-5 fw-normal philosopher" data-aos="fade-down" data-aos-duration="2000">THE WEDDING OF</p>
        ...
        <button type='button' className="btn" data-aos="fade-up" data-aos-duration="3000">
          <Reminder />
        </button>
